        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLevelUp =
                        table.Column<DateTime>(type: "timestamp without time zone", nullable: true,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLevelUp =
                        table.Column<DateTime>(type: "timestamp without time zone", nullable: false,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StarboardRemoveOnBelowThreshold =
                        table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateUserId = table.Column<int>(type: "integer", nullable: true),
                    TemplateGuildId = table.Column<int>(type: "integer", nullable: true),
                    TemplateClubId = table.Column<int>(type: "integer", nullable: true),
                    TemplateBarId = table.Column<int>(type: "integer", nullable: true),
                    DateAdded = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
