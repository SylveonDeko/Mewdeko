...
public static class QuoteExtensions
{
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains a random Quote entity matching the criteria, or null if none found.</returns>
