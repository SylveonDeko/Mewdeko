...
public static class SelfAssignedRolesExtensions
{
    ...
    /// <returns>A task that represents the asynchronous operation. The task result is true if a role was deleted, false otherwise.</returns>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains an IEnumerable of SelfAssignedRole entities for the specified guild.</returns>
