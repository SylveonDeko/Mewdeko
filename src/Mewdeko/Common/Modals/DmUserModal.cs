...
public class DmUserModal : IModal
{
    ...
    ///     the ModalTextInput attribute with a style of TextInputStyle.Paragraph and a placeholder of "send the user a
    ///     message",
    ...
    public string Title
    {
        get
        {
            return "a dev forgot to edit the title of this modal and now looks silly";
        }
    }
}