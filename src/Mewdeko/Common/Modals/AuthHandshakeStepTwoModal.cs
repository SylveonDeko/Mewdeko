...
public class AuthHandshakeStepTwoModal : IModal
{
    ...
    ///     and the ModalTextInput attribute with a style of TextInputStyle.Paragraph and a placeholder of "Enter the
    ///     authorization code you got from our website.".
    /// </remarks>
    [InputLabel("Code")]
    ...
    public string Title
    {
        get
        {
            return "Manual Authentication Step 2";
        }
    }
}