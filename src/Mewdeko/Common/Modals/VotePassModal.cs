...
public class VotePasswordModal : IModal
{
    ...
    ///     and the ModalTextInput attribute with a style of TextInputStyle.Paragraph and a placeholder of "Please enter the
    ///     password. DO NOT SHARE THIS TO ANYONE ELSE".
    ///     It is not a required input.
    /// </remarks>
    [InputLabel("VotePassword")]
    [ModalTextInput("votepassword", TextInputStyle.Paragraph,
        "Please enter the password. DO NOT SHARE THIS TO ANYONE ELSE")]
    [RequiredInput(false)]
