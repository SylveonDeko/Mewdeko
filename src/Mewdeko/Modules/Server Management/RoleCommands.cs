...
{
    /// <summary>
    /// Provides commands for managing roles within a guild, including creation, deletion, synchronization, and user assignment.
    /// </summary>
    [Group]
        ...
        : MewdekoSubmodule<RoleCommandsService>
    {
        ...
        /// </summary>
        /// <remarks>
        /// This command helps in monitoring mass role operations, offering insights into the progress, type, and initiator of each operation.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
        ...
        /// <remarks>
        /// This command adds a specified role to users listed in a text file attached to the command message. It streamlines the process of applying a role to a specific subset of users.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
        ...
        /// <remarks>
        /// This command targets users based on their membership duration, applying a role to those who have been part of the server for longer than the specified time.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
        ...
        /// <param name="role">The role to be added to qualifying users.</param>
        /// <remarks>
        /// Similar to 'AddToUsersOver', but targets new members by applying a role to those who have been part of the server for less than the specified time.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
        ...
        /// <remarks>
        /// This command targets only human members for role removal, allowing bots to retain their assigned roles. It's useful for adjusting roles among human users without affecting bots' configurations.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
        ...
        /// <remarks>
        /// This command is specifically designed to remove a role from bot accounts only, leaving human users' roles intact. Ideal for managing bot permissions collectively.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
        ...
        /// <remarks>
        /// This command allows for the targeted application of a role based on existing role memberships, enabling administrators to dynamically adjust role assignments based on evolving server roles and user groups.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
        ...
        /// <remarks>
        /// Facilitates the cleaning or reorganization of roles within the server by removing a role from users based on their membership in another role. This is particularly useful in situations where roles need to be reassigned or permissions updated en masse.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
        ...
        /// <remarks>
        /// This command combines role addition and removal into a single step for users who have a specific role, streamlining the process of updating user roles and permissions. It's especially useful during role transitions or server restructurings.
        /// </remarks>
        [Cmd, Aliases, RequireContext(ContextType.Guild),
         UserPerm(GuildPermission.ManageRoles), BotPerm(GuildPermission.ManageRoles)]
