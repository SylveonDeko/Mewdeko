...
/// <summary>
///     Lookup tables for Nintendo Switch error codes.
/// </summary>
internal static class SwitchErrorData
{
    /// <summary>
    ///     Maps a Switch error module id to its name.
    /// </summary>
    internal static readonly Dictionary<int, string> SwitchModules = new()
    {
        [1] = "Kernel",
        [2] = "FS",
    ...
    /// <summary>
    ///     Maps a full Switch error code (module + description combined) to a human-readable description.
    ///     Key is the raw error value: (description &lt;&lt; 9) + module.
    /// </summary>
    internal static readonly Dictionary<int, string> SwitchKnownErrorCodes = new()
    {
        [0xE01] = "Session count exceeded",
        ...
        [0x27EE7C] = "(potential) complete account ban",
        ...
        [unchecked((int)0xDEADBEEF)] =
            "Congrats, you found some hexspeak \n \n https://www.youtube.com/watch?v=DLzxrzFCyOs",
        [0x0] =
    ...
    /// <summary>
    ///     Maps a Switch error module id to description ranges that share a common cause.
    /// </summary>
    internal static readonly Dictionary<int, (int Low, int High, string Description)[]> SwitchKnownErrorCodeRanges =
        new()
        {
            [137] =
            [
            ...
            [2] =
            [
                (2000, 2499, "Error: Failed to access SD card."), (2500, 2999, "Error: Failed to access game card."),
                (3500, 3999, "Error: Failed to access MMC."), (4001, 4299, "Error: ROM is corrupted."),
                (4301, 4499, "Error: Save data is corrupted."), (4501, 4599, "Error: NCA is corrupted."),
                (4601, 4639, "Error: Integrity verification failed."),
                (4641, 4659, "Error: Partition FS is corrupted."),
                (4661, 4679, "Error: Built-in-storage is corrupted."), (4681, 4699, "Error: FAT FS is corrupted."),
                (4701, 4719, "Error: HOST FS is corrupted."), (5000, 5999, "Error: Unexpected failure occurred."),
                ...
                (6300, 6399, "Error: Unsupported operation."), (6400, 6499, "Error: Permission denied.")
            ],
            [110] =
            [
    ...
    /// <summary>
    ///     Special-case Switch error codes that don't follow the NNNN-NNNN format. Value is "game:description".
    /// </summary>
    internal static readonly Dictionary<string, string> SwitchGameErrors = new()
    {
    ...
    /// <summary>
    ///     Maps a full Switch error code ("NNNN-NNNN") to a description from Nintendo's support page.
    /// </summary>
    internal static readonly Dictionary<string, string> SwitchSupportPage = new()
    {
        ["2005-0003"] =
