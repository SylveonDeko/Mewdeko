...
namespace Mewdeko.Modules.Games
{
    ...
    {
        /// <summary>
        /// Command group for Cleverbot settings.
        /// </summary>
        [Group]
        public class ChatterBotCommands : MewdekoSubmodule<ChatterBotService>
        {
            /// <summary>
            /// Toggles Cleverbot for the current or specified text channel.
            /// </summary>
            /// <param name="chan">The text channel to toggle Cleverbot for.</param>
            /// <example>.cleverbot #general</example>
