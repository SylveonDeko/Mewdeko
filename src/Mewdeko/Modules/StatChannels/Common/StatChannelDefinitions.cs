...
public static class StatChannelDefinitions
{
    ...
    [
        ...
        new StatChannelDefinition(StatChannelType.ActivePolls, "Active Polls", "Polls",
            ...
            StatChannelDisplayStyle.Plain, false),
        new(StatChannelType.Clock, "Clock", "Server",
            "The current date and time in the server's timezone.", "🕒 %time% %tz%",
            ["%time%", "%date%", "%datetime%", "%weekday%", "%tz%"],
            StatChannelValueKind.Text, StatChannelRequirement.None, "🕒 14:30 UTC",
            StatChannelDisplayStyle.Plain, true),
        new(StatChannelType.MessagesToday, "Messages Today", "Activity",
            "Messages sent in the last 24 hours.", "💬 Today: %count%", [],
            StatChannelValueKind.Number, StatChannelRequirement.None, "💬 Today: 4,812",
            StatChannelDisplayStyle.Comma, false),
        new(StatChannelType.MessagesWeek, "Messages This Week", "Activity",
            "Messages sent in the last 7 days.", "💬 This Week: %count%", [],
            StatChannelValueKind.Number, StatChannelRequirement.None, "💬 This Week: 31,204",
            StatChannelDisplayStyle.Comma, false),
        new(StatChannelType.VoiceHoursToday, "Voice Hours Today", "Activity",
            "Hours spent in voice across all members in the last 24 hours.", "🔊 Today: %count%h", [],
            StatChannelValueKind.Number, StatChannelRequirement.None, "🔊 Today: 96h",
            StatChannelDisplayStyle.Comma, false),
        new(StatChannelType.VoiceHoursWeek, "Voice Hours This Week", "Activity",
            "Hours spent in voice across all members in the last 7 days.", "🔊 This Week: %count%h", [],
            StatChannelValueKind.Number, StatChannelRequirement.None, "🔊 This Week: 611h",
            StatChannelDisplayStyle.Comma, false),
        new(StatChannelType.TopChatter, "Top Chatter", "Activity",
            "The most active chatter of the last 7 days.", "🏆 Chatter: %member.name%",
            ["%member.name%", "%member.id%", "%member.messages%"],
            StatChannelValueKind.Text, StatChannelRequirement.None, "🏆 Chatter: sylveondeko",
            StatChannelDisplayStyle.Plain, false),
        new(StatChannelType.TopVoiceMember, "Top Voice Member", "Activity",
            "The member with the most voice time in the last 7 days.", "🎙️ Voice: %member.name%",
            ["%member.name%", "%member.id%", "%member.hours%"],
            StatChannelValueKind.Text, StatChannelRequirement.None, "🎙️ Voice: sylveondeko",
            StatChannelDisplayStyle.Plain, false),
        new(StatChannelType.RoleMembersOnline, "Role Members Online", "Members",
            "Members holding a role who are not offline.", "🟢 %role.name%: %count%",
            ["%role.name%", "%role.id%", "%role.total%"],
            StatChannelValueKind.Number, StatChannelRequirement.Role, "🟢 Staff: 12",
            StatChannelDisplayStyle.Comma, false),
        new(StatChannelType.TopInviter, "Top Inviter", "Invite Tracking",
            "The member with the most invites.", "🥇 Inviter: %member.name%",
            ["%member.name%", "%member.id%", "%member.invites%"],
            StatChannelValueKind.Text, StatChannelRequirement.None, "🥇 Inviter: sylveondeko",
            StatChannelDisplayStyle.Plain, false),
        new(StatChannelType.InvitesWeek, "Invites This Week", "Invite Tracking",
            "Joins credited to inviters in the last 7 days.", "🔗 This Week: %count%", [],
            StatChannelValueKind.Number, StatChannelRequirement.None, "🔗 This Week: 218",
            StatChannelDisplayStyle.Comma, false),
        new(StatChannelType.MembersLeftToday, "Left Today", "Members",
            "Members who left in the last 24 hours.", "📉 Left Today: %count%", [],
            StatChannelValueKind.Number, StatChannelRequirement.None, "📉 Left Today: 14",
            StatChannelDisplayStyle.Comma, false),
        new(StatChannelType.MembersLeftWeek, "Left This Week", "Members",
            "Members who left in the last 7 days.", "📉 Left This Week: %count%", [],
            StatChannelValueKind.Number, StatChannelRequirement.None, "📉 Left This Week: 97",
            StatChannelDisplayStyle.Comma, false),
        new(StatChannelType.NetGrowthWeek, "Net Growth This Week", "Members",
            "Joins minus leaves over the last 7 days.", "📊 Growth: %count%", ["%joins%", "%leaves%"],
            StatChannelValueKind.Number, StatChannelRequirement.None, "📊 Growth: +805",
            StatChannelDisplayStyle.Plain, false),
        new(StatChannelType.TopGame, "Top Game", "Activity",
            "The most played game or app of the last 7 days. Needs game tracking enabled.", "🎮 %game%",
            ["%game%", "%hours%", "%players%"],
            StatChannelValueKind.Text, StatChannelRequirement.None, "🎮 Minecraft",
            StatChannelDisplayStyle.Plain, false),
        new(StatChannelType.PlayingNow, "Playing Now", "Activity",
            "Members currently in a tracked game or app. Needs game tracking enabled.", "🎮 Playing: %count%", [],
            StatChannelValueKind.Number, StatChannelRequirement.None, "🎮 Playing: 38",
            StatChannelDisplayStyle.Comma, true)
    ];
