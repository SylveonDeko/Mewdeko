...
/// <summary>
/// Represents errors that occur due to insufficient permissions when attempting to apply a stream role within the application.
/// </summary>
public class StreamRolePermissionException : Exception
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StreamRolePermissionException"/> class with a default error message indicating the stream role could not be applied.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StreamRolePermissionException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
    /// </summary>
