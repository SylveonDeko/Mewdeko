...
- `cd ~ && wget https://raw.githubusercontent.com/Kaoticz/Mewdeko-BashScript/1.9k/Mewdeko.service`
...
Here is a list of useful commands if you intend on managing Mewdeko with *systemd*.
