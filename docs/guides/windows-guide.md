## Setting Up Mewdeko on Windows With the Updater
...
*Note: If you want to make changes to Mewdeko's source code, please follow the [From Source][SourceGuide] guide instead.*
...
- [Visual C++ 2010 (x86)] and [Visual C++ 2017 (x64)] (both are required if you want Mewdeko to play music - restart Windows after installation)

#### Setup

- Download and run the [Mewdeko Updater][Updater].
- Click on the + at the top left to create a new bot.
 ![Mewdeko Updater](https://i.imgur.com/KZV49uf.png "Mewdeko Updater")
...
- Make sure Mewdeko is closed and not running  
  (Run `.die` in a connected server to ensure it's not running).
- Open Mewdeko Updater
...
- [ffmpeg-32bit] | [ffmpeg-64bit] - Download the **appropriate version** for your system (32 bit if you're running a 32 bit OS, or 64 if you're running a 64bit OS). Unzip it, and move `ffmpeg.exe` to a path that's in your PATH environment variable. If you don't know what that is, then just move the `ffmpeg.exe` file to Mewdeko/system
- [youtube-dl] - Click to download the file. Then put `youtube-dl.exe` in a path that's in your PATH environment variable. If you don't know what that is, then just move the `youtube-dl.exe` file to Mewdeko/system

[Updater]: https://dl.Mewdeko.bot/
