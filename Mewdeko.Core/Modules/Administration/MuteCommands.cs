    ...
    public partial class Administration
    {
        ...
        public class MuteCommands : MewdekoSubmodule<MuteService>
        {
            ...
            public async Task RemoveOnMute(string yesnt)
            {
                ...
                {
                    case 1:
                    await ctx.Channel.SendConfirmAsync("Role removal on mute and readding on unmute has been enabled!");
                   break;
                   case 0:
                   await ctx.Channel.SendConfirmAsync("Role removal on mute and readding on unmute has been disabled!");
                   break;
