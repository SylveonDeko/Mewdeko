...
namespace Mewdeko.Modules.Utility.Services
{
    public class StarboardService : INService
    {
        ...
        private ConcurrentDictionary<ulong, ulong> _starboardchannels { get; } =
        ...
        private Task OnReactionRemoveAsync(Cacheable<IUserMessage, ulong> message, ISocketMessageChannel channel,
            SocketReaction reaction)
        {
            _ = Task.Run(async () =>
            {
