...
namespace Mewdeko.Modules.SwitchUtils.Services
{
    ...
    {
        public Dictionary<int, string> switch_modules = new Dictionary<int, string> {
            {
                1,
                "Kernel "},
            {
        ...
        public Dictionary<int, string> switch_known_errcodes = new Dictionary<int, string> {
            {
                0x0E01,
        ...
        public Dictionary<int, List<object>> switch_known_errcode_ranges = new Dictionary<int, List<object>> {
            {
                137,
                new List<object> {
                    new List<object> {
        ...
        public Dictionary<string, string> switch_game_err = new Dictionary<string, string> {
            {
                "2-AAB6A-3400",
        ...
        public Dictionary<string, string> switch_support_page = new Dictionary<string, string> {
            {
                "2005-0003",
